    ...
    return Style.from_dict(
        {
            ...
            "md-italic": "italic",
            "md-code": "fg:#5fd7c7",
            "md-code-block": "fg:#d4d4d4",
            "md-code-lang": "fg:#808080 italic",
            # 代码语法高亮（VS Code Dark+ 风格，普通字符用 md-code-block 浅灰）
            "md-tok-keyword": "fg:#c586c0",
            "md-tok-string": "fg:#ce9178",
            "md-tok-comment": "fg:#6a9955",
            "md-tok-number": "fg:#b5cea8",
            "md-tok-function": "fg:#dcdcaa",
            "md-tok-class": "fg:#4ec9b0",
            "md-tok-operator": "fg:#d4d4d4",
            "md-tok-builtin": "fg:#569cd6",
            "md-tok-decorator": "fg:#c586c0",
            "md-link": "fg:#81a2be",
